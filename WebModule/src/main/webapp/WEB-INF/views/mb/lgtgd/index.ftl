...
<div id="main-body">
    <ul>
        ...
        <li class="title">营业时间7:30-22:00联系电话59812542</li>
        <li class="title">Trx${result}&nbsp;TA0E&nbsp;0018&nbsp;
        ${note.consumeDate?string("MM/dd/yyyy HH:mm")}</li>
        <li class="title">${note.consumeDate?string("MM/dd/yyyy HH:mm")}   销售收据    ${note.consumeDate?string("HH:mm")}</li>
        ...
        <table style="width: 100%" class="shop-table">
            ...
            <tr>
                <td>收款总额：</td>
                <td style="opacity: 0">${note.consumeMoney}</td>
                <td>找回:</td>
                <td>0.00</td>
            </tr>
            <tr>
                <td>实收：</td>
                <td colspan="3">${note.consumeMoney}</td>
            </tr>
            <tr>
                <td>已买商品总数:</td>
                <td>${products?size}</td>
            ...
            <p>
                ...
                交易金额：                 ${note.consumeMoney}
                ================${note.consumeDate?string("HH:mm:ss")}=================
                乐购天津塘沽外滩店()
                营业时间7:30-22:00联系电话59812542
                店号：TA0E    机号：0018  流水号：${result}
                收银员：2004        日期：${note.consumeDate?string("yyyy.MM.dd")}
                时间：${note.consumeDate?string("HH:mm:ss")}     消费金额：${note.consumeMoney}
