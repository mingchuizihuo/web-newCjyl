...
<style>
    ...
    <div id="print-main-body">
        <ul>
            ...
            <br>
            <li style="margin: 5px 0px;margin-left: 5%">交易号：211841 <span style="margin-left: 20px;">小票号：1</span></li>
            <li style="margin: 5px 0px;margin-left: 5%">收款台：122 <span style="margin-left: 20px;">收银员：00034</span></li>
            ...
            <li style="margin-top: 10px;">商户名称：天津manBear咖啡</li>
            <li>商户编号：898120053112734</li>
            <li>终端编号：01083373</li>
            <li>交易类型：消费（SALE）</li>
