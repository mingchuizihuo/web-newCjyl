    ...
    *{
    ...
    <div id="main-body">
        <ul>
            ...
            <br>
            <li>交易类型：消费（SALE）</li>
            <li>批次号：000637 <span style="margin-left: 30px">凭证号：021417</span></li>
            <li>授权号：566462 <span style="margin-left: 30px">有效期：${note.effectDate}</span></li>
            <li>参考号：${swipeNum}</li>
