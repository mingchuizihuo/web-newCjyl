...
<style>
    *{
    ...
    <div id="main-body">
        <ul>
            <li class="title">向阳屯客户单 <span style="margin-left: 5px;font-size: 8px;">结账单</span></li>
            <br>
            <li>开始时间：${note.consumeDate?string("yyyy/MM/dd HH:mm:ss")}</li>
            <li>结束时间：${note.swipeDate?string("yyyy/MM/dd HH:mm:ss")}</li>
            <li>房台号：018(A7) <span style="margin-left: 20px;">餐别：</span></li>
            ...
            <li><nobr>服务员：王子晴 打印：${note.swipeDate?string("yyyy/MM/dd HH:mm:ss")}</nobr></li>
            <br>
            <br>
            <br>
            <br>
            ...
            <li>商户名称:向阳屯</li>
            <li>商户编号:8981120058156900</li>
            <li>终端编号:01232745</li>
            <li>班次号：2017041600001  操作员号:01</li>
            ...
            <li>交易类型:消费</li>
            <li>批次号:000001</li>
            <li style="font-size: 10px;">凭证号:001452  授权码:000000</li>
            ...
            <li>CSN:001 ARQC:4A15CE86C455F757</li>
